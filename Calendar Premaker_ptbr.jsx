...
// (c) vd
// ai-js@mail.ru 
// pt-br by viniciusmelo@bsd.com.br



var sMS = "Janeiro,Fevereiro,Março,Abril,Maio,Junho,Julho,Agosto,Setembro,Outubro,Novembro,Dezembro";
var sDS = "seg,ter,qua,qui,sex,sab,dom";
var sHS = "1/1,8/3,1/5,25/12";


var pMS = "Digite nos nomes dos meses separados por vírgula ou deixe em branco para o padrão";
var pDS = "Digite nos nomes dos dias da semana separados por vírgula ou deixe em branco para o padrão";
var pHS = "Especifique os feriados, no formato D/M[,D/M,D/M...]";

var AppCap = "Calendar Premaker (for Adobe Illustrator CS) PT-BR\n\n";
